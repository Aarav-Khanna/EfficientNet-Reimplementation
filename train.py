...
def main():
    ...
    parser.add_argument('--batch_size', type=int, default=256,
                      help='Batch size for training (optimized for T4)')
    ...
    parser.add_argument('--num_workers', type=int, default=4,
                      help='Number of workers for data loading (optimized for T4)')
    ...
    scheduler = create_scheduler(optimizer, args.num_epochs, args.learning_rate)
...
def create_scheduler(optimizer, num_epochs, learning_rate):
    """
    Create cosine learning rate decay
    """
    scheduler = optim.lr_scheduler.CosineAnnealingLR(
        optimizer,
        T_max=num_epochs,
        eta_min=learning_rate * 0.01  # minimum learning rate is 1% of initial
    )
    return scheduler
